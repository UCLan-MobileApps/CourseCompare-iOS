...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        ...
        if (tableView == resultsTable) {
            ...
            if (indexPath.row == 3) {
                ...
                cell.textLabel.font = [UIFont systemFontOfSize:17];
                cell.selectionStyle = UITableViewCellSelectionStyleGray;
                cell.backgroundColor = [UIColor colorWithRed:0.980 green:0.675 blue:0.086 alpha:1];
    ...
    if (indexPath.section == 1) {
        ...
        if (cell == nil) {
            ...
            //black line space horizontal
            /*
            CGRect lineViewRect = CGRectMake(10, 40, 660, 1);
            UIView *lineView = [[UIView alloc] initWithFrame:lineViewRect];
            lineView.backgroundColor = [UIColor blackColor];
            [cell.contentView addSubview:lineView];
            
            
            //black line space vertical
            CGRect line2ViewRect = CGRectMake(340, 35, 1, 150);
            UIView *line2View = [[UIView alloc] initWithFrame:line2ViewRect];
            line2View.backgroundColor = [UIColor blackColor];
       ...
       // UITextView *studymodeTitleLabel = (UITextView *)[cell.contentView viewWithTag:cstudymode];
       // studymodeTitleLabel.text = [rowData objectForKey:@"studyMode"];
        
       // UITextView *subjectTitleLabel = (UITextView *)[cell.contentView viewWithTag:csubject];
       // subjectTitleLabel.text = [rowData objectForKey:@"subject"];
