...
-(void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component {
    ...
    if (pickerNumber == 1) {
        ...
        pickerName = [NSString stringWithFormat:@"%@", [[providerArray objectAtIndex:row] objectForKey:@"Name"]];
        pickerString = [NSString stringWithFormat:@"%@", [[providerArray objectAtIndex:row] objectForKey:@"Code"]];
    }
