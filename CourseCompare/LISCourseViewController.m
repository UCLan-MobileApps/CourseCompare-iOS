...
- (void)viewDidLoad
{
    ...
    courseTable.separatorColor = [UIColor colorWithRed:0.949 green:0.426 blue:0.141 alpha:1];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 4) {
        ...
        cell.backgroundColor = [UIColor colorWithRed:0.949 green:0.426 blue:0.141 alpha:1];
